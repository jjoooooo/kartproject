                ...
                children: [
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return InkWell(
                          onTap: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) =>  CatItemList(name:"Laptops")),
                            );
                          },
                          child: Container(
                            height: 86,
                                    ...
                                    children: [
                                      Positioned(
                                        ...
                                        child: Container(height: 156,
                                          ...
                                          child: Image.network('${p.images![0]}',fit: BoxFit.fitHeight, scale: 1.0),
                                        ),
                                      ),
                                      Positioned(top: 176,
                                          right: 0,
                  ...
                  Align(
                      ...
                      child: ElevatedButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  FullList(name:"Top Products")),
                        );
